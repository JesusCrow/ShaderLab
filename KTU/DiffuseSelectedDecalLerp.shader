Shader "_KTU/DiffuseSelectedDecal" {
Properties {
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	fixed3 selectionColor = lerp(fixed3(0, 0, 1), fixed3(1, 1, 0), saturate(sin(_Time.w * 2) * 100 / 2 + 0.5));
	c.rgb = lerp(c.rgb, selectionColor, _SelectionFactor * 0.1 * (1 - InstantiationTimeFactor()));
